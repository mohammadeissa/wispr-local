...
<img src="assets/hero.svg" alt="Wispr Local — hold a key, speak, release. Clean text at your cursor, 100% on-device." width="820">

<br/>

**Push-to-talk voice dictation for Apple Silicon Macs. Nothing leaves your machine.**
...
A fully on-device clone of [Wispr Flow](https://wisprflow.ai). Hold a key, speak, release —
Whisper transcribes your voice, a local LLM strips the filler and fixes punctuation, and the
clean text is pasted straight into whatever app has focus. No account, no API key, no network.

**Pipeline:** mic → [mlx-whisper](https://github.com/ml-explore/mlx-examples) (Metal-accelerated STT)
...
- **Yours to change** — ~1,400 lines of readable Python, MIT-licensed.
